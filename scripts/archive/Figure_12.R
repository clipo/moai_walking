...
# Save as SVG
svglite("../figures/Figure_12_distribution_analysis.svg", 
        width = 12, height = 6)
create_figure12()
dev.off()
...
# Export data
write.csv(moai_data, "../figures/Figure_12_data.csv", row.names = FALSE)

cat("\n=== FIGURE CREATED SUCCESSFULLY ===\n")
cat("Files saved:\n")
cat("- figures/Figure_12_distribution_analysis.svg (vector format)\n")
cat("- figures/Figure_12_distribution_analysis.png (600 dpi)\n")
cat("- figures/Figure_12_distribution_analysis_preview.png (150 dpi for preview)\n")
cat("- figures/Figure_12_distribution_analysis.pdf\n")
cat("- figures/Figure_12_data.csv (data used)\n")
...
writeLines(caption_text, "../figures/Figure_12_caption.txt")
