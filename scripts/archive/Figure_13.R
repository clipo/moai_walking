...
png("../figures/Figure_13_size_analysis.png", 
    width = 10, height = 6, units = "in", res = 600)
create_figure13()
dev.off()

# Also save a standard resolution PNG for quick viewing (150 dpi)
png("../figures/Figure_13_size_analysis_preview.png", 
    width = 10, height = 6, units = "in", res = 150)
create_figure13()
dev.off()

# Save as SVG
svglite("../figures/Figure_13_size_analysis.svg", 
        width = 10, height = 6)
create_figure13()
dev.off()

# Save as PDF
pdf("../figures/Figure_13_size_analysis.pdf", 
    width = 10, height = 6)
create_figure13()
dev.off()

# Export data
write.csv(size_data, "../figures/Figure_13_data.csv", row.names = FALSE)

cat("\n=== FIGURE CREATED SUCCESSFULLY ===\n")
cat("Files saved:\n")
cat("- figures/Figure_13_size_analysis.svg (vector format)\n")
cat("- figures/Figure_13_size_analysis.png (600 dpi)\n")
cat("- figures/Figure_13_size_analysis_preview.png (150 dpi for preview)\n")
cat("- figures/Figure_13_size_analysis.pdf\n")
cat("- figures/Figure_13_data.csv (data used)\n")
